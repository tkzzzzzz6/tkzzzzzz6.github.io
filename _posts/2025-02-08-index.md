...
:root {
    /* 统一为蓝黑风格 */
    --bg-primary: #0d1117;         /* 深黑色背景 */
    --bg-secondary: #161b22;       /* 次级背景 */
    --text-primary: #c9d1d9;         /* 主文本颜色 */
    --text-secondary: #8b949e;       /* 次要文本 */
    --border-color: #30363d;         /* 边框颜色 */
    --card-shadow: 0 2px 4px rgba(0,0,0,0.5);
    --accent-color: #58a6ff;         /* 蓝色高亮 */
    --accent-hover: #1f6feb;         /* 悬停时的蓝色 */
    /* 定义RGB变量，用于需要 rgba() 的场合 */
    ...
    /* 保留其他变量（如 Doki 相关），如果需要则可以自行调整 */
    --theme-background: url('https://doki-theme.unthrottled.io/stickers/zero_two/dark/background.png');
    --theme-background-light: url('https://doki-theme.unthrottled.io/stickers/emilia/light/background.png');
    --doki-background: url('https://doki-theme.unthrottled.io/backgrounds/wallpapers/zero_two/dark/zero_two_dark_wall.png');
    --doki-sticker: url('https://doki-theme.unthrottled.io/stickers/zero_two/dark/zero_two.png');
    --doki-primary: #ff6b6b;
    --doki-secondary: #4ecdc4;
...
<div class="sticker-container">
    <img
        class="sticker"
        alt="Theme Sticker"
        src="https://doki-theme.unthrottled.io/stickers/zero_two/dark/zero_two.png"
    />
</div>
